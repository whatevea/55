      ...
      {loading ? (
        ...
        <div className="flex flex-col md:w-1/3 w-full border py-8 px-10 rounded-xl my-10 md:mx-auto shadow-[rgba(0,_0,_0,_0.24)_0px_1px_5px] animate__animated animate__fadeInRight">
          <div className=" flex flex-col">
            <svg
              className="w-[150px] h-[30px] mx-auto"
          ...
          <div className="text-center">
            <h3 className="text-normal font-semibold text-green-600">
              Please choose Freelancer or Hirer
            </h3>
          </div>
          <div className="accountType flex flex-col my-2 mt-5 md:flex-row md:justify-center md:w-full items-center gap-4 ">
            <div
              className={`rounded-md h-22 w-full cursor-pointer border-2 border-green-600 text-center py-1.5 ${
          ...
          <div className="mt-10 w-full">
            <form className="space-y-4" onSubmit={registerUser} noValidate>
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-2">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`block rounded-md border-2 border-solid border-gray-300 px-2 py-1.5 text-gray-900 placeholder:text-gray-400 w-full focus:border-green-600 sm:text-sm sm:leading-6 focus:outline-none ${
                      validation.lname ? "" : "border-red-500"
                    }`}
                  />
                </div>
                {!validation.lname && (
              ...
              <div>
                <button
                  type="submit"
                  className="flex w-full justify-center rounded-md bg-green-600 hover:bg-green-500 px-3 py-1.5 text-base font-semibold leading-6 text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
            ...
            <p className="mt-2 text-center text-sm text-gray-500">
              ...
              <Link
                to="/auth/login"
                className="font-semibold leading-6 text-green-600 hover:text-green-500 text-base"
              >
                Login
              </Link>
            </p>
