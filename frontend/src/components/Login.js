            ...
            <div className="mt-10 mx-auto">
              <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                <div className="flex flex-col">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className={`block rounded-md border-2 border-solid ${
                        emailError ? "border-red-500" : "border-gray-300"
                      } px-2 py-1.5 text-gray-900 placeholder:text-gray-400 w-full focus:border-green-600 sm:text-sm sm:leading-6 focus:outline-none`}
                    />
                    {emailError && (
                ...
                <div className="flex flex-col">
                  <label
                    htmlFor="password"
                    className="inline-block text-base font-medium leading-6 text-gray-900 "
                  >
                    Password:
                  </label>
                  <div className="mt-2">
              ...
              <div className="text-sm text-center mt-2">
                <a
                  href="#"
                  className="font-semibold text-green-600 hover:text-green-500 text-center"
                >
                  Forgot password?
                </a>
              </div>
