...
//   return (
//     <div className="flex flex-col gap-3 w-full border-2 border-yellow-600 justify-center">
//       <label className="text-xl font-bold text-center">
//         Are You Building Product Or Service Please Select One
//       </label>
//       <div className="text-center flex justify-center gap-4">
//         <span>
//           <button className="rounded-md border-2 border-green-600 px-3 py-1.5 font-semibold">
//             Product
//           </button>
//         </span>
//         <span>
...
//         Write a title for your Product or Service Post.
//       </p>
//       <input
//         type="text"
//         onChange={handleChange}
//         value={title} // This ensures the input is controlled
//         className="rounded-md p-2 w-[80%] border-2 focus:border-green-600 outline-none mx-auto"
//       />
...
const Title = ({ setIsValid, updateJobData, jobData }) => {
  ...
  useEffect(() => {
    const isValid =
      ...
      selectedClass;
    setIsValid(isValid);
  }, [selectedOption, title, selectedUniversity, selectedClass]);
  ...
  useEffect(() => {
    ...
    setSelectedOption(jobData.selectedOption || "");
    setSelectedUniversity(jobData.university || "");
    setSelectedClass(jobData.class || "");
  }, [jobData]);
    ...
    <div className="flex flex-col gap-3 w-full border-2 border-yellow-600 justify-center">
      ...
      <div className="text-center flex justify-center gap-4">
        <span>
          <button
            className={`rounded-md px-3 py-1.5 font-semibold ${
              selectedOption === "Product" // Conditional styling based on selected option
        ...
        <span>
          <button
            className={`rounded-md px-3 py-1.5 font-semibold ${
              selectedOption === "Service" // Conditional styling based on selected option
                ? "bg-green-600 text-white" // Green background and white text when selected
                : "border-2 border-green-600"
            }`}
      ...
      <p className="font-semibold w-[80%] mx-auto">
        Write a title for your {selectedOption || "Product or Service"} Post.
      </p>
      <input
        type="text"
        onChange={handleChange}
