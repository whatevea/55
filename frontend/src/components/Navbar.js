            ...
            <header className="px-4 shadow-sm shadow-green-600">
                ...
                <nav className="flex items-center justify-start md:justify-between h-16">
                    <div className="flex items-center justify-between">
                        ...
                        <a href="#" className="md:ml-1"><svg className="w-[150px] h-[30px]" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="gap-6 hidden lg:flex">
                            <ul className="flex justify-between gap-4 ml-4">
                                {menuItems.map((item, index) => (
                                    ...
                                    >
                                        {item.label}
                                        <i className={`fa-solid fa-angle-down ml-1 mt-1 scale-80 ${hoveredIndex === index ? 'rotate-180 duration-300 ease-in-out' : ''}`}></i>
                                    </Link>
                                ))}
                            </ul>
                        </div>
