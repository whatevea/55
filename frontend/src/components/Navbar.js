    ...
    return (
        <div className="w-full h-full flex flex-col justify-center">
            <div className="_allitems w-full flex items-center font-semibold ml-4 gap-4 ">
                ...
                <div className={` duration-500 md:static absolute bg-white md:min-h-fit min-h-[60vh] left-0 ${open ? 'top-[9%]' : 'top-[-100%]'} md:w-screen w-full flex items-center px-5`}>
                ...
                <div className="searchbox w-auto10">
                    <div className="border-2 flex items-center border-black rounded-3xl p-2">
